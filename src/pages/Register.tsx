    ...
    <div className="flex min-h-screen bg-gray-100">
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <div className="mt-6">
            <p className="text-xs text-center text-gray-500">
              ...
              <a href="#" className="text-travel-600 hover:text-travel-500">Terms of Service</a>
              {' '}and{' '}
              <a href="#" className="text-travel-600 hover:text-travel-500">Privacy Policy</a>.
            </p>
          </div>
        </div>
      </div>
      <div className="hidden lg:block relative w-0 flex-1">
        <div className="absolute inset-0 h-full w-full object-cover">
          <div className="h-full w-full bg-gradient-to-r from-blue-600 to-travel-600"></div>
          <div className="absolute inset-0 bg-black opacity-50"></div>
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-12">
            <h1 className="text-4xl font-bold mb-6">Join our travel community</h1>
            <p className="text-xl max-w-md text-center">
              Create an account to book flights, track your journeys, and get personalized travel recommendations to your dream destinations.
            </p>
          </div>
        </div>
      </div>
